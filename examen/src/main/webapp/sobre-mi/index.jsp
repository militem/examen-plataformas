  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a href="#" class="nav-link  active"><i class="fa-solid fa-circle-info me-2"></i>Sobre mi</a>
        </li>
      </ul>
...
<div class="container mt-5 mb-5">
	<div class="row mov-left">
		<div class="col-12 col-md-4">
			<img src="../assets/images/yo2.jpg" class="img-fluid rounded">
		</div>
		<div class="col-12 col-md-8">
			<div class="fs-3 fw-bold">Sobre mi</div>
			Soy Alex Terreros, estudiante de la Universidad Politécnica Salesiana de 5to nivel. Mi gran pasión desde los 12 años ha sido 
			el desarrollo de software y la ciberseguridad. Me gradué del colegio como Técnico en Aplicaciones Informáticas.<br>
			Mis hobbies son:
			<ul>
				<li>Videojuegos</li>
				<li>Fútbol</li>
				<li>Ajedrez</li>
				<li>Leer sobre Ciencia Ficción futurista</li>
				<li>Ver películas</li>
			</ul>
		</div>
	</div>
