<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.examen.negocio.*, java.time.*, java.time.format.DateTimeFormatter"%>
<!DOCTYPE html>
<html>
<head>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
        	<a class="nav-link active" href="../negocios/"><i class="fa-solid fa-shop me-2"></i>Negocios</a>
        </li>
        <li class="nav-item">
          <a href="#" class="nav-link"><i class="fa-solid fa-circle-info me-2"></i>Sobre mi</a>
        </li>
      </ul>
...
<div class="container">
	<%
    	...
    	Datos dt = new Datos();
		out.print(dt.getNegocio(id));
		String nombres = request.getParameter("nombres");
		String email = request.getParameter("email");
		String mensaje = request.getParameter("mensaje");
		if(nombres != null && email != null && mensaje != null){
			if(dt.guardarComentario(nombres, email, mensaje, fecha)){
				out.print("<script>Toast.fire({icon: 'success',title: 'Se registró su comentario.'})</script>");
			}else{
				out.print("<script>Toast.fire({icon: 'error',title: 'No registró su comentario.'})</script>");
			}
		}
	%>
</div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAF1wn_ExNlIqXG0HsCOIaGjqghT7LGziA&callback=initMap" defer></script>
